        ...
        compiler.plugin('after-emit', function (compilation, cb) {
            ...
            _lodash2.default.forEach(fileDependencies, function (file) {
                if (compilationFileDependencies.has(file)) {
                    ...
                    var _fileDependencies = compilation.fileDependencies;


                    Array.isArray(_fileDependencies) ? _fileDependencies.push(file) : _fileDependencies.add(file);
                }
            });
            ...
            _lodash2.default.forEach(contextDependencies, function (context) {
                if (compilationContextDependencies.has(context)) {
                    ...
                    var _contextDependencies = compilation.contextDependencies;


                    Array.isArray(_contextDependencies) ? _contextDependencies.push(context) : _contextDependencies.add(context);
                }
            });
